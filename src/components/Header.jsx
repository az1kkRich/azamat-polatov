  ...
  return (
    <section id="home" className="min-h-screen Header flex flex-col justify-center items-center text-center px-4">
        <FadeInWhenVisible delay={0.8}>
            <h2 className="bg-green-200/20 px-4 py-2 mb-3 rounded-xl font-bold font-mono">Software engineer</h2>        
        </FadeInWhenVisible>
      ...
      <FadeInWhenVisible delay={0.2}>
        <h1 className="text-4xl md:text-6xl xl:text-7xl font-bold mb-4">
          Hi, I'm Azamat Po'latov
        </h1>
      </FadeInWhenVisible>

      <FadeInWhenVisible delay={0.4}>
        <p className="text-lg md:text-xl xl:text-2xl text-gray-300 mb-6 max-w-xl">
          Frontend Developer crafting modern and responsive web interfaces.
        </p>
      </FadeInWhenVisible>
