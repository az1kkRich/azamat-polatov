        ...
        <section className="Proccess pt-10 pb-15 px-4" id="how-i-work">
            <div className="container mx-auto  px-4">
                ...
                <SlideInWhenVisible direction="up" className="mb-10">
                    <h1 className="text-center text-md xl:text-4xl font-bold ">How I <span className="text-blue-500">Work</span></h1>
                </SlideInWhenVisible>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
                    ...
                    {steps.map((step, index) => (
                        <FadeInWhenVisible key={index} delay={0.2}>
                            <div className="relative bg-[#1a1a35] rounded-xl shadow z-10 overflow-hidden hover:shadow-blue-500/20 transition ">
